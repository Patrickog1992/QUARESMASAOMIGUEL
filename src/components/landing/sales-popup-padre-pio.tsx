...
export function SalesPopupPadrePio() {
  ...
  useEffect(() => {
    ...
    const showRandomNotification = () => {
      ...
      timeoutId = setTimeout(showRandomNotification, 300000);
    };
      ...
      <Card className="bg-blue-800 text-white shadow-lg">
        <CardContent className="p-2 flex items-center gap-2">
          ...
          <p className="text-xs font-semibold">
            {notification.name} {notification.location} acabou de receber as orações do Padre Pio.
          </p>
        </CardContent>
      </Card>
    </div>
