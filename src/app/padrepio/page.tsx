      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12 flex flex-col items-center justify-center text-center z-10">
        <Card className="w-full max-w-md bg-gray-800/50 backdrop-blur-sm border-amber-400/30 text-center">
            <CardContent className="p-6 md:p-8 space-y-6">
                <h1 className="text-2xl font-bold text-amber-300">As Orações Secretas do Padre Pio para uma vida de milagres!</h1>
                <Image
                    src="https://i.imgur.com/H1qvjJ8.png"
                    alt="Padre Pio"
                    width={400}
                    height={225}
                    className="rounded-lg mx-auto shadow-lg"
                    data-ai-hint="Padre Pio praying"
                />
                <div className="pt-4">
