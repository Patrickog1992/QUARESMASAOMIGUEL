...
const options = [
  'Sim, todos os dias',
  'Às vezes, quando lembro ou preciso',
  'Raramente ou nunca',
];

export default function PalavrasReiSalomaoQuiz2Page() {
  return (
        ...
        <main className="flex-grow container mx-auto px-4 py-8 md:py-12 flex flex-col items-center justify-center text-center z-10">
            <Card className="w-full max-w-lg bg-gray-800/50 backdrop-blur-sm border-amber-400/30 text-center">
                <CardContent className="p-6 md:p-8 space-y-6">
                    <h1 className="text-2xl font-bold text-amber-300">Você costuma orar diariamente?</h1>
                    <div className="space-y-4">
                        {options.map((option) => (
                        <Link href="/7palavrasreisalomao/quiz3" key={option} passHref className="block">
