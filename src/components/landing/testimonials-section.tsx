...
const testimonialsData: Testimonial[] = [
  {
    ...
    text: 'A Chave de Cristo é uma das experiências espirituais mais fortes que já vivi. Quando comecei a praticar essas orações, percebi mudanças reais na minha vida e na vida das pessoas que oravam comigo. Se você está aqui, é porque seu anjo quer te mostrar esse caminho 🙏',
    likes: 2134,
    time: '3 h',
    replies: [
      {
  ...
  },
  {
    ...
    avatarHint: 'priest portrait',
    text: 'Eu vivi o que está nesse vídeo. A Chave de Cristo não é só um livro, é um encontro real com Deus. Quem fizer com fé, vai sentir a mudança. Assista até o final e se permita viver essa experiência!',
    likes: 2001,
    time: '1 h',
    replies: [
      {
  ...
  },
  {
    ...
    avatarHint: 'priest portrait',
    text: 'Essa oração reacendeu minha fé. A Chave de Cristo é mais do que uma devoção, é um presente direto do Céu. Se você está aqui, é porque essa bênção também é para você. Receba com fé!',
    likes: 1654,
    time: '1 h',
    replies: [
      {
  ...
  },
  {
    ...
    avatarHint: 'woman portrait',
    text: 'Meu marido voltou a trabalhar depois de usar a Chave de Cristo por 7 dias seguidos! Deus é fiel! 🙌',
    likes: 412,
    time: '1 h',
  },
  {
  ...
  },
  {
    ...
    avatarHint: 'woman portrait',
    text: 'Tô arrepiada! As 22 palavras sagradas são surreais. 😭🌟',
    likes: 267,
    time: '1 h',
  },
  {
  ...
  },
  {
    ...
    avatarHint: 'woman portrait',
    text: 'Confiei na Chave de Cristo e hoje estou vivendo meu milagre! 🙏😭 Glória a Deus!',
    likes: 354,
    time: '1 h',
  },
  {
    ...
    avatarHint: 'man portrait',
    text: 'Senti um arrepio diferente ao usar a Chave de Cristo! Que loucura! 🙌',
    likes: 322,
    time: '1 h',
  },
];
