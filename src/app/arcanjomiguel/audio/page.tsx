...
const AudioComPlayer = () => {
  const audioHtml = `<div style="height: 228px; width: 204px;"><iframe src="https://audio.com/embed/audio/1846508069917685?theme=image" style="display:block; border-radius: 1px; border: none; height: 204px; width: 204px;"></iframe><a href='https://audio.com/patrick-oliveira-2' style="text-align: center; display: block; color: #A4ABB6; font-size: 12px; font-family: sans-serif; line-height: 16px; margin-top: 8px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">@patrick-oliveira-2</a></div>`;
  return (
