...
const testimonials = [
    {
        ...
        text: 'A oração perdida do Rei Salomão é um tesouro espiritual. Quando a recitei, senti uma sabedoria ancestral e uma clareza para a prosperidade. Orem com fé, e a sabedoria de Salomão guiará seus caminhos. Se você está aqui, é um sinal. 🙏',
        likes: 2134,
        time: '3 h',
        replies: [
          {
            ...
            text: 'Padre, comecei a orar e sinto uma paz e uma direção que não sentia há anos. Obrigada por compartilhar essa bênção! 🙌',
            likes: 254,
            time: '3 h',
          },
        ],
    },
    {
        ...
        avatarHint: 'priest portrait',
        text: 'Vi de perto o poder desta oração. Não são apenas palavras, são uma conexão direta com a sabedoria divina de Salomão. Assista ao vídeo e sinta essa sabedoria em sua vida.',
        likes: 2001,
        time: '1 h',
        replies: [
          {
    ...
    },
    {
        ...
        avatarHint: 'priest portrait',
        text: 'A oração de Salomão é um presente do céu para os momentos de decisão. Ela renova a fé e traz a certeza da direção divina. Receba essa graça em sua vida!',
        likes: 1654,
        time: '1 h',
        replies: [
          {
            ...
            avatarHint: 'woman portrait',
            text: 'Comecei hoje e já me sinto mais sábia para enfrentar meus problemas. 🙌',
            likes: 135,
            time: '1 h',
          },
        ],
    },
    {
        ...
        avatarHint: 'priest portrait',
        text: 'Há orações que nos tocam de forma única. A de Salomão tem uma força especial. Que mais pessoas possam ter acesso a essa fonte de sabedoria.',
        likes: 1361,
        time: '1 h',
        replies: [
        {
            ...
            text: 'Meu pai chorou ouvindo. Ele estava perdido nos negócios. Hoje ele rezou comigo, pedindo a sabedoria de Salomão. 🙏',
            likes: 318,
            time: '2 d',
        },
        ],
    },
    {
        ...
        avatarHint: 'woman portrait',
        text: 'Minha empresa estava quase falindo. Fiz a oração de Salomão por 7 dias. Hoje, fechamos um contrato que salvou nosso ano! 🙌',
        likes: 412,
        time: '1 h',
    },
    {
    ...
    },
    {
        ...
        avatarHint: 'man portrait',
        text: '3º dia de oração e recebi uma notícia maravilhosa sobre um investimento antigo. Tenho certeza que foi a sabedoria de Salomão. 🙌',
        likes: 198,
        time: '1 h',
    },
    {
