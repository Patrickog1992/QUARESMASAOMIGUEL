...
export default function ReiSalomaoPage() {
  return (
    <div className="dark relative flex flex-col min-h-screen bg-amber-900 text-white overflow-x-hidden">
      <TopBanner className="bg-amber-600 text-amber-950" text="ATENÇÃO : Devido aos grandes ricos do nosso país estar tentando nos processar por revelar o segredo esse vídeo ficará disponível somente até hoje" />
      <HebrewPattern />
