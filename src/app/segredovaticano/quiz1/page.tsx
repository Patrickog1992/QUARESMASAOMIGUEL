...
const quizOptions = [
  { emoji: '🥺', text: 'Dor física (doenças crônicas, limitações)' },
  { emoji: '😩', text: 'Crise financeira (dívidas, falta de dinheiro)' },
  { emoji: '😔', text: 'Problemas familiares (filhos distantes, conflitos)' },
  { emoji: '😞', text: 'Solidão/angústia (vazio espiritual)' },
];

export default function SegredoVaticanoQuiz1Page() {
  return (
            ...
            <CardContent className="space-y-6 text-blue-950">
              ...
              <div className="space-y-4">
                {quizOptions.map((option, index) => (
                  <Link href="/segredovaticano/quiz2" key={index} className="block w-full">
                    <Button
                      size="lg"
                      variant="outline"
