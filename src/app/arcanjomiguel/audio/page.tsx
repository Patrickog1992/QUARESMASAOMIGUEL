                ...
                <Card className="w-full max-w-md bg-gray-800/50 backdrop-blur-sm border-amber-400/30 text-center">
                    <CardContent className="p-6 md:p-8 space-y-6">
                        ...
                        <div className="flex justify-center">
                            <iframe 
                                src="https://audio.com/embed/audio/1846506684604200?theme=image" 
                                style={{display:'block', borderRadius: '1px', border: 'none', height: '204px', width: '204px'}}
                                frameBorder="0" 
                                allow="autoplay"
                                title="Audio message from Frei Gilson"
                            ></iframe>
                        </div>
