...
function RosaryPattern() {
  return (
    <div className="absolute inset-0 z-0 opacity-5 text-blue-900 pointer-events-none">
...
export default function OracaoVaticanoQuizPage() {
  return (
    <div className="dark relative flex flex-col min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12 flex flex-col items-center justify-center text-center z-10">
        <div className="max-w-2xl w-full">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-primary-foreground mb-4 uppercase">
            FOI REVELADO AS ORAÇÕES SECRETAS QUE O VATICANO ESTAVA GUARDANDO A 7 CHAVES PARA FAZER UM MILAGRE EM SUA VIDA
          </h1>
          ...
          <Link href="/oracaovaticano/quiz1">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg md:text-xl py-6 md:py-8 px-6 md:px-12 uppercase animate-pulse shadow-lg h-auto whitespace-normal text-center">
              Continuar
            </Button>
          </Link>
        </div>
